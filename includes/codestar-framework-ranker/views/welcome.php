...
if ( ! class_exists( 'CSF_Welcome' ) ) {
  class CSF_Welcome{
    ...
    public function __construct() {
      ...
      if ( CSF::$premium && ( ! CSF::is_active_plugin( 'codestar-framework-ranker/codestar-framework.php' ) || apply_filters( 'csf_welcome_page', true ) === false ) ) { return; }
    ...
    public static function add_plugin_action_links( $links, $plugin_file ) {
      ...
      if ( $plugin_file === 'codestar-framework-ranker/codestar-framework.php' && ! empty( $links ) ) {
